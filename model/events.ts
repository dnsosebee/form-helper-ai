...
import { fieldTargets } from "./profileForm";
...
export const responseSuggestionZodSchema = z.object({
...
export const fieldEventResponseFunctions: ChatCompletionCreateParams.Function[] = [
  {
    name: "create_submit_task_response",
  ...
  {
    name: "create_question_task_response",
  ...
  {
    name: "create_field_task_response",
